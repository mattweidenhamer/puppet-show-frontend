...
class ActorTestCase(TestCase):
    ...
    def test_image_data(self):
        ...
        actor_1.setImage(Actor.Attributes.START_SPEAKING, test_image_1)
        actor_1.setImage(Actor.Attributes.NOT_SPEAKING, test_image_2)
        actor_1.setImage(Actor.Attributes.NOT_SPEAKING, test_image_1)
        actor_1.setImage(Actor.Attributes.START_SPEAKING, test_image_2)
...
class SceneTestCase(TestCase):
    ...
    def test_user_link(self):
        scene_1 = Scene.objects.get(scene_name="test_scene")
        user_1 = DiscordPointingUser.objects.get(discord_data__user_username="testuser")
