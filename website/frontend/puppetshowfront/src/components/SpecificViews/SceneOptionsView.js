...
const saveChanges = () => {
  //The best way to save changes is probably to modify the default "scene" prop
  //And then push and save it when the save button is pressed.
  //So each element will need a caller function for itself.
  console.log("Pretend I am saving changes!");
};
